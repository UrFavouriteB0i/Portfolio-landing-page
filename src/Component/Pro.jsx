...
export const Pro = () => {
  return (
    <div className='pb-10'>
      <div className='flex flex-col items-center pt-20 lg:px-40 md:px-20 sm:px-0'>
        <h4>PROJECTS</h4>
        ...
        <div className='container mx-auto px-4 lg:px-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 gap-x-4 mx-20 mt-8'>
            {/* Project 1 */}
      ...
      <section className='container pt-10 px-4 flex flex-col items-center'>
        <a
