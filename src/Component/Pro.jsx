  ...
  return (
    <div className='pb-10'>
      <div className='flex flex-col items-center pt-20 px-4 xl:px-40 md:px-20 sm:px-0'>
        <h4 className='text-white text-[28px] font-bold text-white md:text-[40px] lg:text-[52px]'>PROJECTS</h4>
        ...
        <div className='container mx-auto px-4 xl:px-6'>
          <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-y-8 gap-x-4 xl:mx-20 mt-8'>
            ...
            <div className='flex items-center space-x-2'>
              ...
              <div className='font-InterBld text-white text-sm sm:text-base w-full max-w-xs'>
                <p>EC Brain Detection</p>
                <span className='font-InterMed text-white text-xs sm:text-sm block'>
